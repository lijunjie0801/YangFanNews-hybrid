...
@implementation NSData (NSNewBase64)
...
+ (NSData *)dataFromBase64String:(NSString *)aString
{
	...
	size_t outputLength;
	void *outputBuffer = NSNewBase64Decode([data bytes], [data length], &outputLength);
...
- (NSString *)base64EncodedString
{
	size_t outputLength;
	char *outputBuffer =
		NSNewBase64Encode([self bytes], [self length], true, &outputLength);
